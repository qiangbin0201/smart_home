...
public class LockPatternView extends View {
     ...
     * 正常状态的颜色
     */
    private static final int NORMAL_COLOR = 0xff929292;
    /**
     * 选中状态的颜色
     */
    private static final int SELECTED_COLOR = 0xecc93c;
    ...
    public LockPatternView(Context context, AttributeSet attrs) {
        ...
        mLinePaint.setColor(getResources().getColor(R.color.black_nomal));
        mLinePaint.setStyle(Paint.Style.STROKE);

        mRadius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20, getResources().getDisplayMetrics()) / 5;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (PointView pointView : mSelectedPointViewList) {
            mCirclePaint.setColor(getResources().getColor(R.color.black_nomal));
...
//
//        return false;
        return Math.sqrt((x - cx) * (x - cx) + (y - cy) * (y - cy)) < radius * 5;
    }
